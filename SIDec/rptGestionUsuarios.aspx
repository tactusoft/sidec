<%@ Page Title="" Language="C#" MasterPageFile="~/AuthenticNew.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="rptGestionUsuarios.aspx.cs" Inherits="SIDec.rptGestionUsuarios" ViewStateMode="Enabled" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="card-header card-header-main">
                    <div class="row">
                        <div class="col-12 text-primary">
                            <h4>Reporte - Gesti&oacute;n de usuarios</h4>
                        </div>
                    </div>
                </div>
                                                                ...
                                                                <div class="gv-w">
                                                                    ...
                                                                    <asp:GridView ID="gvConsolidado" CssClass="gv" runat="server" AutoGenerateColumns="false" AllowPaging="false" PageSize="100">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField DataField="cantidad" HeaderText="Cantidad" DataFormatString="{0:N0}" ItemStyle-CssClass="t-r" />
                                                                        </Columns>
                                                                ...
                                                                <div class="gv-w">
                                                                    ...
                                                                    <asp:GridView ID="gvDetalle" CssClass="gv" runat="server" AutoGenerateColumns="false" AllowPaging="false" PageSize="100">
                                                                        <Columns>
                                                                            <asp:BoundField DataField="usuario" HeaderText="Usuario" />
                                                                            <asp:BoundField DataField="modulo" HeaderText="Modulo" />
                                                                            <asp:BoundField DataField="fecha" HeaderText="Fecha" HtmlEncode="false" DataFormatString="{0:dd/MMM/yyyy}" ItemStyle-CssClass="t-c w120" />
    ...
    <script>
        ...
        function HideMensajeCRUD() {
            document.getElementById('DivMsgReporte').style.display = "none";
        }
