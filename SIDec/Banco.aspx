<%@ Page Title="" Language="C#" MasterPageFile="~/AuthenticNew.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" CodeBehind="Banco.aspx.cs" Inherits="SIDec.Banco" ViewStateMode="Enabled" EnableEventValidation="false" %>
...
<%@ Register Src="~/UserControls/Particular/ProjectBankHeader.ascx" TagPrefix="uc" TagName="ProjectBankHeader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--******************************* Modal ******************************--%>
    <%--********************************************************************--%>
    <div id="modBanco" class="modal fade" data-backdrop="static" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:LinkButton ID="btnConfirmarBanco" runat="server" Text="" CssClass="btn btn-outline-primary" OnClick="btnConfirmar_Click" data-dismiss="modal">
    ...
    <%--*************** gridviews --%>
    <%--********************************************************************--%>
    <asp:HiddenField runat="server" ID="hfEvtGVBanco" Value="" />
    <asp:HiddenField ID="hfGVBancoSV" runat="server" />
    <asp:HiddenField ID="hfGVBancoSH" runat="server" />
    <asp:HiddenField ID="hfGVBancoManzanasSV" runat="server" />
    <asp:HiddenField ID="hfGVBancoManzanasSH" runat="server" />
    <asp:HiddenField ID="hfGVBancoCesionesSV" runat="server" />
    <asp:HiddenField ID="hfGVBancoCesionesSH" runat="server" />
    <asp:HiddenField ID="hfGVBancoActosSV" runat="server" />
    <asp:HiddenField ID="hfGVBancoActosSH" runat="server" />
    <asp:HiddenField ID="hfGVBancoLicenciasSV" runat="server" />
    <asp:HiddenField ID="hfGVBancoLicenciasSH" runat="server" />
    <asp:HiddenField ID="hfGVBancoVisitasSV" runat="server" />
    <asp:HiddenField ID="hfGVBancoVisitasSH" runat="server" />

    <asp:HiddenField ID="hdd_Proyecto_Banco_Id" runat="server" />
    ...
    <div id="divData" runat="server">
        <div class="col-12" role="main">
            ...
            <div class="card mt-3 mb-5">
                <div class="card-header card-header-main">
                    <div class="row">
                        <div class="col-sm-6 text-primary">
                            <h4>
                                <asp:Label ID="lblTitle" runat="server" Text="Seguimiento"></asp:Label></h4>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="card-body">
                    <asp:UpdatePanel runat="server" ID="upBanco" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:HiddenField ID="hddsectionview" runat="server" Value="" />

                            <asp:MultiView runat="server" ID="mvBanco">
                                <asp:View runat="server" ID="vBanco">
                                    <div class="gv-w">
                                        <asp:GridView ID="gvBanco" CssClass="gv" runat="server" PageSize="20" AllowPaging="true"
                                            DataKeyNames="idbanco,cod_usu_responsable,idproyecto, editable"
                                            AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" OnPageIndexChanging="gvBanco_PageIndexChanging"
                                            AllowSorting="true" OnSorting="gvBanco_Sorting" OnSelectedIndexChanged="gvBanco_SelectedIndexChanged"
                                            OnRowDataBound="gvBanco_RowDataBound" OnRowCreated="gv_RowCreated" OnRowCommand="gvBanco_RowCommand">
                                            <Columns>
                                ...
                                <asp:View runat="server" ID="vBancoDetalle">
                                    <div runat="server" id="divBanco" class="">
                                        <div id="accordion">
                                            <div class="card">
                                                <div class="card-header card-header-dark">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto ml-auto card-header-buttons">
                                                            <div id="ContentPlaceHolder1_pFichaProyectoAction">

                                                                <div class="btn-group">
                                                                   <asp:LinkButton ID="btnReturn" runat="server" CssClass="btn" Text="Volver al proyecto" CausesValidation="false" Visible="false" ToolTip="Volveer a proyecto" OnClick="btnFichaProyectoReturn_Click">
                                                ...
                                                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordion">
                                                    <div class="card-body">
                                                        <asp:UpdatePanel runat="server" ID="upFichaProyecto" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <uc:ProjectBankHeader ID="PB_Header" runat="server" ValidationGroup="vgFichaProyecto" />
                                                                <div>
                                                                                    ...
                                                                                    <asp:Panel ID="pFichaProyectoExecAction" runat="server">
                                                                                        <div class="btn-group flex-wrap">
                                                                                            <asp:LinkButton ID="btnFichaProyectoAccionFinal" runat="server" CssClass="btn btn-primary btn-sm" ValidationGroup="vgFichaProyecto"
                                                                                                OnClientClick="if(Page_ClientValidate('vgFichaProyecto')) return openModal('modBanco');">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-auto ml-auto card-header-buttons">
                                                                                    <asp:Panel ID="pFichaProyectoAction" runat="server">
                                                                                        <div class="btn-group">
                                                                                            <asp:LinkButton ID="btnFichaProyectoReturn" runat="server" CssClass="btn" Text="Volver al proyecto" CausesValidation="false" Visible="true" ToolTip="Volver a proyecto" OnClick="btnFichaProyectoReturn_Click">
										                                                        <i class="fas fa-arrow-alt-circle-left"></i>
                                                                                            </asp:LinkButton>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
                                                    <div class="card-body">
                                                        <uc:Activity ID="ucActivity" runat="server" ControlID="BancoActividad" Section="Create" OnToList="ucActivity_ToList" OnSave="ucActivity_OnSave" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card">
                                                ...
                                                <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
                                                    <div class="card-body">
                                                        <uc:ActivityManagement ID="ucActivityManagement" runat="server" ControlID="BancoActividad" Section="Create" OnToList="ucActivity_ToList" OnViewDoc="uc_ViewDoc"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card">
                                                ...
                                                <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordion">
                                                    <div class="card-body">
                                                        <uc:Tracing ID="ucTracing" runat="server" ControlID="BancoSeguimiento" OnToList="ucTracing_ToList" OnViewDoc="uc_ViewDoc"
                        ...
                        <Triggers>
                            ...
                            <asp:AsyncPostBackTrigger ControlID="btnBancoNavFirst" EventName="Click" />
                            <asp:AsyncPostBackTrigger ControlID="btnBancoNavBack" EventName="Click" />
                            <asp:AsyncPostBackTrigger ControlID="btnBancoNavNext" EventName="Click" />
                            <asp:AsyncPostBackTrigger ControlID="btnBancoNavLast" EventName="Click" />
                            <asp:AsyncPostBackTrigger ControlID="gvBanco" EventName="SelectedIndexChanged" />
                            <asp:AsyncPostBackTrigger ControlID="ucActivity" />
                ...
                <div class="card-footer noprint">
                    <asp:UpdatePanel runat="server" ID="upBancoFoot" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:UpdatePanel runat="server" ID="upBancoMsg" UpdateMode="Conditional" class="alert-card">
                                <ContentTemplate>
                                    <div runat="server" id="msgBanco" class="alert d-none" role="alert"></div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto va-m mr-auto">
                                    <asp:Label ID="lblBancoCuenta" runat="server"></asp:Label>
                                </div>
                                <div class="col-auto">
                                    <asp:Panel ID="pBancoNavegacion" runat="server">
                                        <div class="btn-group">
                                            <asp:LinkButton ID="btnBancoNavFirst" runat="server" CssClass="btn btn-outline-secondary" Text="" CausesValidation="false" CommandName="First" ToolTip="Ir al primer registro" OnClick="btnBancoNavegacion_Click">
											  <i class="fas fa-angle-double-left"></i>
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnBancoNavBack" runat="server" CssClass="btn btn-outline-secondary" Text="" CausesValidation="false" CommandName="Back" ToolTip="Registro anterior" OnClick="btnBancoNavegacion_Click">
											  <i class="fas fa-angle-left"></i>
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnBancoNavNext" runat="server" CssClass="btn btn-outline-secondary" Text="" CausesValidation="false" CommandName="Next" ToolTip="Registro siguiente" OnClick="btnBancoNavegacion_Click">
											  <i class="fas fa-angle-right"></i>
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnBancoNavLast" runat="server" CssClass="btn btn-outline-secondary" Text="" CausesValidation="false" CommandName="Last" ToolTip="Ir al último registro" OnClick="btnBancoNavegacion_Click">
