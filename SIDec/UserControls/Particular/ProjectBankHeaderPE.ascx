<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectBankHeaderPE.ascx.cs" Inherits="SIDec.UserControls.Particular.ProjectBankHeaderPE" %>
...
<asp:UpdatePanel ID="upPBHeader" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <uc:MultiSelectGrid Id="ucMsUpz" runat="server" ControlID="StrategicProy.UPZ" OnAccept="ucMsUpz_Accept" OnRemove="ucMsUpz_Remove"/> 
        <uc:MultiSelectGrid Id="ucMsResponsable" runat="server" ControlID="StrategicProy.Responsible" OnAccept="ucMsResponsable_Accept" OnRemove="ucMsResponsable_Remove"/> 
        ...
        <asp:Panel ID="pnlPBDetail" runat="server">
            ...
            <div class="row">
                ...
                <div class="form-group-sm col-12 col-sm-6 col-lg-4 col-xl-3">
                ...
                <div class="form-group-sm col-12 col-sm-6 col-lg-5 col-xl-4">
                    <label class="lblBasic">Tratamiento</label>
                    <asp:TextBox runat="server" ID="txtTratamientos" CssClass="form-control form-control-xs" Enabled="false"></asp:TextBox>
                </div>
                <div class="form-group-sm col-12 col-sm-6 col-lg-3 col-xl-4">
                ...
                <div class="form-group-sm col-12 col-md-6 col-lg-5 col-xl-8">
                    <label class="lblBasic">Localidad / UPZ</label>
                    <asp:Button runat="server" ID="txtlocalidadupz" CssClass="form-control form-control-xs disabled" Style="text-align: left;" OnClick="btnLocalidadUpz_Click" />
                </div>
                <div class="form-group-sm col-12 col-md-6 col-lg-4">
                    <label class="lblBasic">UPL</label>
                    <asp:TextBox runat="server" ID="txtUpl" CssClass="form-control form-control-xs" Enabled="false"></asp:TextBox>
                </div>
                <div class="form-group-sm col-6 col-md-3">
                ...
                <div class="form-group-sm col-12 col-md-6">
                    <div class="row">
                        <div class="form-group-sm col-10" runat="server">
                        ...
                        <div class="form-group-sm col-2" runat="server">
                            <asp:Label ID="lblnumusers" runat="server" class="lblBasic"></asp:Label><br />
                            <asp:LinkButton ID="txtresponsable" runat="server" CssClass="btn btn-success btn-sm " Text="" CausesValidation="false" ToolTip="Usuarios colaboradores" OnClick="btnresponsable_Click">
                ...
                <div class="form-group-sm col-12">
                    ...
                    <asp:TextBox runat="server" ID="txt_descripcion" CssClass="form-control form-control-xs" MaxLength="500" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                </div>
                <div class="form-group-sm col-12" id="dvObservacionesPA" runat="server">
                    ...
                    <asp:TextBox runat="server" ID="txt_observacion" CssClass="form-control form-control-xs" MaxLength="500" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                </div>
            </div>
            <div class="form-group-sm col-12 ">
                <div class="row">
        ...
        <asp:Panel ID="pnlPBEdition" runat="server">
            ...
            <div class="row">
                ...
                <div class="form-group-sm col-12 col-sm-6 col-lg-5 col-xl-4">
                    <uc:ListBox ID="ddlTratamiento" runat="server" Label="Tratamiento" ControlID="ProjectBankHeaderTratamiento" Enabled="true" />
                </div>
                <div class="form-group-sm col-12 col-sm-6 col-lg-3 col-xl-4">
                ...
                <div class="form-group-sm col-12 col-md-6 col-lg-5 col-xl-8">
                    <label for="ddl_idupz" class="lblBasic">Localidad / UPZ</label>
                    <asp:Button runat="server" ID="btnLocalidadUpz" CssClass="form-control form-control-xs" Style="text-align: left;" OnClick="btnLocalidadUpz_Click" />
                </div>
                <div class="form-group-sm col-12 col-md-6 col-lg-4">
                    <uc:ListBox ID="ddlUpl" runat="server" Label="UPL" ControlID="ProjectBankHeaderUpl" Enabled="true" />
                </div>
                <div class="form-group-sm col-6 col-md-3">
                ...
                <div class="form-group-sm col-12 col-md-6">
                    <div class="row">
                        ...
                        <div class="form-group-sm col-2" runat="server">
                            <asp:Label ID="lblnumusersedit" runat="server" class="lblBasic"></asp:Label><br />
                            <asp:LinkButton ID="btnresponsable" runat="server" CssClass="btn btn-success btn-sm " Text="" CausesValidation="false" ToolTip="Usuarios colaboradores" OnClick="btnresponsable_Click">
						        <i class="fas fa-users"></i>
                            </asp:LinkButton>
                        </div>
                    </div>
                                ...
                                <div class="row" style="background-color: #f2f2f2;">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group-sm col">
                                            ...
                                            <asp:LinkButton ID="btnAccept" runat="server" CssClass="btn btn-outline-primary" Text="Aceptar" ValidationGroup="vgImagenCabecera" CausesValidation="true" OnClick="btnAccept_Click">
                                                <i class="fas fa-check"></i>&nbsp;&nbsp;Aceptar
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnCancel" runat="server" CssClass="btn btn-outline-secondary" CausesValidation="false" OnClick="btnCancel_Click">
