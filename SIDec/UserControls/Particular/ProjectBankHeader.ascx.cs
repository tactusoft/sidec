...
{
    public partial class ProjectBankHeader : UserControl
    {
        ...
        protected void ddl_idlocalidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            LoadDropDownUPZ();
        }
        ...
        {
            ddl_idlocalidad.DataSource = oLocalidades.sp_s_localidades();
            ddl_idlocalidad.DataTextField = "nombre_localidad";
            ddl_idlocalidad.DataValueField = "cod_localidad";
            ddl_idlocalidad.DataBind();

            LoadDropDownIdentidad(ddl_idtipo_proyecto, "72", "2, 3");
            LoadDropDownIdentidad(ddl_idestado_proyecto, "55", "3"); //3-ignore las opciones exclusivas de Proyectos estratégicos
            LoadDropDownIdentidad(ddl_idtratamiento, "21", "3"); //3-ignore las opciones exclusivas de Proyectos estratégicos
            LoadDropDownIdentidad(ddl_idinstrumento, "51", "3"); //3-ignore las opciones exclusivas de Proyectos estratégicos
        ...
        private void LoadDropDownUPZ()
        {
            ...
            ddl_idupz.DataSource = oUPZ.sp_s_upz(ddl_idlocalidad.SelectedValue);
        ...
        private void Save_BancoEntidades()
        {
        ...
        {
            string idTratamientos = ddl_idtratamiento.SelectedValue;
        ...
        private void ViewControls()
        {
            ...
            ddl_cod_usu_responsable.Enabled = Enabled;
        }
        #endregion
    }
}