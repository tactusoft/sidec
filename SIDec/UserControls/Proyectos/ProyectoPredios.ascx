<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="ProyectoPredios.ascx.cs" Inherits="SIDec.UserControls.Proyectos.ProyectoPredios" %>
                ...
                <asp:GridView ID="gvProyectoPredio" CssClass="gv" runat="server" PageSize="500" AllowPaging="true" DataKeyNames="au_proyecto_predio,chip" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                    ...
                    <Columns>
                        <asp:TemplateField ShowHeader="true" ItemStyle-CssClass="t-c gridcolmin_120" HeaderText="CHIP">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnView" runat="server" CssClass="btn btn-outline-warning btn-xs uc-py-pd-btn-inline" CausesValidation="false" CommandName="_Go"
