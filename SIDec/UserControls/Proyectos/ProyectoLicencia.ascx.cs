...
{
    public partial class ProyectoLicencia : UserControl
    {
        ...
        private const string _SOURCEPAGE = "ProyectoLicencia";
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            Enabled = false;
            hdd_au_proyecto_licencia.Value = ProyectoLicenciaID.ToString();
            if (ProyectoLicenciaID == 0)
        ...
        protected void gvProyectoLicencia_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (int.TryParse(e.CommandArgument.ToString(), out int rowIndex))
            {
                ...
                ProyectoLicenciaID = rowIndex >= 0 ? Convert.ToInt32(gvProyectoLicencia.DataKeys[rowIndex]["au_proyecto_licencia"].ToString()) : 0;
