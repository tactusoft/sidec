<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProyectoInformacion.ascx.cs" Inherits="SIDec.UserControls.Proyectos.ProyectoInformacion" %>
                    ...
                    <div class="subcard-body">
                        <div class="card-header card-header-main text-center">
                            ...
                            <asp:Panel ID="pProyectoAction" runat="server">
                                <div class="col-auto ml-auto tab-card-header-buttons">
                                    <div class="btn-group">
                            ...
                            <asp:Panel ID="pProyectoExecAction" runat="server">
                                <div class="col-auto tab-card-header-buttons" style="padding-top: .5rem; padding-bottom: .25rem;">
                        ...
                        <div class="card-body" runat="server" id="mvProyectosSection">
                            <div id="tab-1">
                               ...
                               <%-- <div class="row" id="pnlCumplido" runat="server" Visible="false">
                                    <div class="form-group-sm col-12 col-sm-6 col-md-3">
                                        <label class="">Cómo cumple </label>
                                        <asp:DropDownList runat="server" ID="ddl_id_como_cumple" CssClass="form-control form-control-xs" AppendDataBoundItems="true" >
                                            <asp:ListItem Value="">-- Seleccione opción</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="form-group-sm  col-12 col-sm-6 col-md-3">
                                        <label for="txt_fecha_inicio_obras" class="">Fecha</label>
                                        <ajax:CalendarExtender ID="cal_fecha_cumple" runat="server" FirstDayOfWeek="Sunday" TargetControlID="txt_fecha_cumple" PopupButtonID="txt_fecha_cumple" Format="yyyy-MM-dd" />
                                        <asp:TextBox runat="server" ID="txt_fecha_cumple" CssClass="form-control form-control-xs" TextMode="Date"></asp:TextBox>
                                    </div>
                                    <div class="form-group-sm col-12 col-sm-6 col-md-3">
                                        <label for="txt_area_bruta" class="">Área obtenida</label>
                                        <div class="input-group input-group-xs">
                                            <asp:TextBox runat="server" ID="txt_area_cumple" CssClass="form-control form-control-xs" MaxLength="15" onkeypress="return SoloDecimal(event);"></asp:TextBox>
                                            <div class="input-group-append">
                            ...
                            <div id="tab-2" class="hidden">
                                <div class="row">
                                    <div runat="server" id="divAreas" class="col-sm-12 col-lg-2">
                                        <div class="row">
                                            <div class="form-group-sm col-6 col-md-3 col-lg-11">
                                    ...
                                    <div runat="server" id="divViviendas" class="col-sm-12 col-lg-4 uc-py-section-middle uc-center">
                                        <asp:Label ID="lblVIviendas" runat="server" class="fwb">Viviendas (unidades)</asp:Label>
                                        <div class="row dvTbb">
                                            <div class="form-group-sm col-2"></div>
                                            <div class="form-group-sm col-10">
                                                <div class="row dvTbb">
                                    ...
                                    <div class="col-sm-12 col-lg-6" style="text-align: center">
                                        <div class="row" runat="server" id="dvTiposVivienda">
                                            <div class="form-group-sm col-4">
                                                <asp:Label runat="server" ID="lblTipo" class="">Tipo vivienda</asp:Label>
                                                <asp:RequiredFieldValidator runat="server" SetFocusOnError="true" CssClass="invalid-feedback" Display="Dynamic" ValidationGroup="vgTipoVivienda" ControlToValidate="ddlTipoVivienda">
                                                            <uc:ToolTip width="130px" ToolTip="Dato requerido" runat="server"/>
                                                </asp:RequiredFieldValidator>
                                                <asp:DropDownList runat="server" ID="ddlTipoVivienda" CssClass="form-control form-control-xs">
                                                    <asp:ListItem Value="">-- Seleccione --</asp:ListItem>
                                                    <asp:ListItem Value="1">VIP</asp:ListItem>
                                                    <asp:ListItem Value="2">VIS</asp:ListItem>
                                                    <asp:ListItem Value="3">No VIS</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="form-group-sm col-3">
                                                <asp:Label runat="server" ID="lblArea" class="">&Aacute;rea (m<sup>2</sup>)</asp:Label>
                                                <asp:RequiredFieldValidator runat="server" SetFocusOnError="true" CssClass="invalid-feedback" Display="Dynamic" ValidationGroup="vgTipoVivienda" ControlToValidate="txt_area">
                                                        <uc:ToolTip width="130px" ToolTip="Dato requerido" runat="server"/>
                                                </asp:RequiredFieldValidator>
                                                <asp:TextBox runat="server" ID="txt_area" CssClass="form-control form-control-xs" Enabled="false"></asp:TextBox>
                                                <ajax:FilteredTextBoxExtender ID="ftbarea" runat="server" FilterType="Numbers" TargetControlID="txt_area" />
                                            </div>
                                            <div class="form-group-sm col-3">
                                                <asp:Label runat="server" ID="lblCantidad" class="">Cantidad</asp:Label>
                                                <asp:RequiredFieldValidator runat="server" SetFocusOnError="true" CssClass="invalid-feedback" Display="Dynamic" ValidationGroup="vgTipoVivienda" ControlToValidate="txt_cantidad">
                                                    <uc:ToolTip width="130px" ToolTip="Dato requerido" runat="server"/>
                                                </asp:RequiredFieldValidator>
                                                <asp:TextBox runat="server" ID="txt_cantidad" CssClass="form-control form-control-xs" Enabled="false"></asp:TextBox>
                                                <ajax:FilteredTextBoxExtender ID="ftbcantidad" runat="server" FilterType="Numbers" TargetControlID="txt_cantidad" />
                                            </div>
                                            <div class="form-group-sm col-2" style="position:relative;">
                                                <asp:LinkButton ID="BtnAddrArea" runat="server" Text="" CssClass="btn btn-primary btn-xs uc-py-btn-div-btm-lft" OnClick="BtnAddrArea_Click"
                                                    ValidationGroup="vgTipoVivienda" >
                                        ...
                                        <div class="row">
                                            <div class="form-group-sm col-12">
                                                <div class="row">
                                                    <div class="form-group-sm col-4">
                                                        <div class="gv-w uc-py-div-con-scroll">
                                                            <div class="dv-title-gv"> VIP </div>
                                                            <asp:GridView ID="gvVIP" CssClass="gv" runat="server" PageSize="500" AllowPaging="false" DataKeyNames="area_m2" AutoGenerateColumns="false"
                                                                AllowSorting="false" EmptyDataText="No hay registros para presentar" ShowHeaderWhenEmpty="true" OnRowCommand="gvTipoVivienda_RowCommand" >
                                                                <Columns>
                                                                    <asp:BoundField DataField="iddistribucion" Visible="false" />
                                                                    <asp:BoundField DataField="area_m2" HeaderText="Área" />
                                                                    <asp:BoundField DataField="cantidad_viviendas" HeaderText="Cantidad" />
                                                                    <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="t-c" HeaderStyle-CssClass="t-c">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-grid-delete" Text="Eliminar" CausesValidation="false"
                                                                                CommandName="1" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" ToolTip="Eliminar registro"> 
										                                        <i class="far fa-trash-alt"></i>
                                                                            </asp:LinkButton>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                ...
                                                                <HeaderStyle CssClass="gvHeaderXsm" />
                                                    ...
                                                    <div class="form-group-sm col-4">
                                                        <div class="gv-w uc-py-div-con-scroll">
                                                            <div class="dv-title-gv"> VIS</div>
                                                            <asp:GridView ID="gvVIS" CssClass="gv" runat="server" PageSize="500" AllowPaging="false" DataKeyNames="area_m2" AutoGenerateColumns="false"
                                                                AllowSorting="false" EmptyDataText="No hay registros para presentar" ShowHeaderWhenEmpty="true" OnRowCommand="gvTipoVivienda_RowCommand">
                                                                <Columns>
                                                                    <asp:BoundField DataField="idDistribucion" Visible="false" />
                                                                    <asp:BoundField DataField="area_m2" HeaderText="Área" />
                                                                    ...
                                                                    <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="t-c" HeaderStyle-CssClass="t-c">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-grid-delete" Text="Eliminar" CausesValidation="false"
                                                                                CommandName="2" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" ToolTip="Eliminar registro"> 
										                                        <i class="far fa-trash-alt"></i>
                                                                            </asp:LinkButton>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                    ...
                                                    <div class="form-group-sm col-4">
                                                        <div class="gv-w uc-py-div-con-scroll">
                                                            <div class="dv-title-gv">No VIS</div>
                                                            <asp:GridView ID="gvNoV" CssClass="gv" runat="server" PageSize="500" AllowPaging="false" DataKeyNames="area_m2" AutoGenerateColumns="false"
                                                                AllowSorting="false" EmptyDataText="No hay registros para presentar" ShowHeaderWhenEmpty="true" OnRowCommand="gvTipoVivienda_RowCommand">
                                                                <Columns>
                                                                    <asp:BoundField DataField="idDistribucion" Visible="false" />
                                                                    <asp:BoundField DataField="area_m2" HeaderText="Área" />
                                                                    ...
                                                                    <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="t-c" HeaderStyle-CssClass="t-c">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-grid-delete" Text="Eliminar" CausesValidation="false"
                                                                                CommandName="3" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" ToolTip="Eliminar registro"> 
										                                        <i class="far fa-trash-alt"></i>
                                                                            </asp:LinkButton>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                ...
                <div class="row">
                    <div class="gv-w">
                        <asp:GridView ID="gvProyecto" CssClass="gv" runat="server" PageSize="500" AllowPaging="false" DataKeyNames="au_proyecto,cod_usu_responsable,idactor,id_resultado_proyecto" AutoGenerateColumns="false"
                            AllowSorting="true" EmptyDataText="No hay registros para presentar" ShowHeaderWhenEmpty="true" OnSorting="gvProyecto_Sorting" Width="99%"
