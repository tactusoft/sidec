...
{
    public partial class ProyectoPredios : UserControl
    {
        ...
        private const string _SOURCEPAGE = "ProyectoPredios";
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            Enabled = false;
            hdd_au_proyecto_predio.Value = ProyectoPredioID.ToString();
            if (ProyectoPredioID == 0)
        ...
        protected void gvProyectoPredio_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (int.TryParse(e.CommandArgument.ToString(), out int rowIndex))
            {
                ...
                if (rowIndex >= gvProyectoPredio.Rows.Count)
                    rowIndex = 0;
                ProyectoPredioID = rowIndex >= 0 ? Convert.ToInt32(gvProyectoPredio.DataKeys[rowIndex]["au_proyecto_predio"].ToString()) : 0;
        ...
        private void EnabledControls()
        {
            ...
            btnGoPredio.Visible = !(txt_declaratoria.Text == "") && !Enabled;
        }
