<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="ProyectoLicencia.ascx.cs" Inherits="SIDec.UserControls.Proyectos.ProyectoLicencia" %>
...
<%@ Register Src="~/UserControls/MessageBox.ascx" TagName="MessageBox" TagPrefix="uc" %>
    <script type="text/javascript" src="./UserControls/Proyectos/Proeyectos.js"></script>
